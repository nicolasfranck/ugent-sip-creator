 ...
 *
 */
public class InterfaceDef extends METSElement
{
    /**
     * Construct a METS interfaceDef
     * 
     * @param n 
     ...
     */     
    public InterfaceDef(Node n) throws METSException
    {
        super(n, Constants.ELEMENT_INTERFACEDEF);
    }
