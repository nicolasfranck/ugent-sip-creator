...
/**
 * Class representing the METS mechanism element
 * 
 * @author Scott Yeadon
 *
 */
public class Mechanism extends METSElement
{
    /**
     * Construct a METS mechansim
     * 
     * @param n 
     ...
     */     
    public Mechanism(Node n) throws METSException
    {
        super(n, Constants.ELEMENT_MECHANISM);
    }
