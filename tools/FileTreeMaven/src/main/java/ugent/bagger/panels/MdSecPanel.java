...
public class MdSecPanel extends JPanel{
    ...
    public JComponent createButtonPanel(){
        ...
        addButton.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent ae){                                
                monitor(new ugent.bagger.workers.TaskAddMdSecFromFile(),"importing..");                
            }
        });
        importButton.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent ae) {                
                monitor(new ugent.bagger.workers.TaskAddMdSecFromImport(),"importing..");
            }
        });
        transformButton.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent ae) {
                monitor(new ugent.bagger.workers.TaskAddMdSecFromTransform(),"transforming..");               
            }
        });
        return panel;
    }
