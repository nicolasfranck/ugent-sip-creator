...
public class AgentForm extends AbstractForm{
    ...
    protected JComponent createFormControl() {
        ...
        ugent.bagger.helper.SwingUtils.setJComponentsEnabled(componentsOtherRole,false);
        builder.row();
        
        final JComponent [] componentsOtherType = builder.add("OTHERTYPE");
        ugent.bagger.helper.SwingUtils.setJComponentsEnabled(componentsOtherType,false);
        builder.row();        
        ...
        getFormModel().getValueModel("ROLE").addValueChangeListener(new PropertyChangeListener(){
            ...
            public void propertyChange(PropertyChangeEvent pce) {
                ...
                ugent.bagger.helper.SwingUtils.setJComponentsEnabled(componentsOtherRole,enabled);
                ugent.bagger.helper.SwingUtils.setJComponentsEnabled(componentsOtherType,enabled);
            }
        });
