...
public class SaveBagHandlerOld extends AbstractAction implements Progress {
    private static final Log log = LogFactory.getLog(SaveBagHandlerOld.class);
    ...
    public SaveBagHandlerOld(BagView bagView) {
        super();
